...
describe('user UsageView', () => {
  ...
  it('exports csv with user-safe fields and custom billing columns', async () => {
    ...
    expect(csv.getCsv()).toContain('IP Address')
    expect(csv.getCsv()).toContain('Image Output Tokens')
    expect(csv.getCsv()).toContain('Billable Duration Seconds')
    expect(csv.getCsv()).toContain('Billable Characters')
    expect(csv.getCsv()).toContain('Billed Cost')
    expect(csv.getCsv()).toContain('Original Cost')
    expect(csv.getCsv()).toContain('Image Output Cost')
    expect(csv.getCsv()).toContain('203.0.113.10')
    expect(csv.getCsv()).toContain(',4057,50,278272,4,150,12,345,')
    expect(csv.getCsv()).toContain('0.08100000')
    expect(csv.getCsv()).not.toContain('Upstream Endpoint')
    expect(csv.getCsv()).not.toContain('account_cost')
    expect(csv.getCsv()).not.toContain('account_rate_multiplier')
