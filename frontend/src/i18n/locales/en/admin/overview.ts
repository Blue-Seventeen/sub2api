export default {
    ...
    groups: {
      ...
      openaiLive: {
        ...
        unsupportedMessage: 'Live is unavailable in this build until its sessions use the unified billing settlement path. The setting remains disabled to prevent unbilled usage.',
        acknowledge: 'OK'
      },
