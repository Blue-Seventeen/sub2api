export default {
  ...
  usage: {
    ...
    standardTotalCost: 'Standard total cost',
    actualCost: 'Actual',
    accountCost: 'Cost',
    userBilled: 'User billed',
    accountBilled: 'Account billed',
    upstreamTotalCostHint: 'upstream total',
  ...
  availableChannels: {
    ...
    pricing: {
      ...
      billingModeImage: 'Image (Per Image/Size)',
      ...
      imageUnitPrice: 'Per-image/size price',
  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        imageTiers: 'Image Tiers (Per Image/Size)',
        addTier: 'Add Tier',
        ...
        perRequestPriceRequired: 'Default price or billing tiers required for per-request/image billing mode',
    ...
    */
    ...
    subscriptions: {
      ...
      adjustHint: 'Leave blank to keep days unchanged. Enter positive to extend or negative to shorten (remaining days must be > 0).',
      ...
      guide: {
        ...
        step1: {
          ...
          line2: 'Set billing type to "Subscription", configure daily/weekly/monthly/custom quota limits',
        ...
        actions: {
          adjust: 'Adjust',
          adjustDesc: 'Adjust validity or used quota windows',
          resetQuota: 'Reset Quota',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksPlaceholder: 'Leave empty to use the built-in 3 blocks. Supports an array or a JSON object with blocks.',
