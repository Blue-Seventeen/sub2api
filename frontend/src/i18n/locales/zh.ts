export default {
  ...
  usage: {
    ...
    totalCost: '总消费',
    standardCost: '标准',
    standardTotalCost: '标准总成本',
    actualCost: '实际',
    accountCost: '成本',
    userBilled: '用户扣费',
    accountBilled: '账号扣费',
    upstreamTotalCostHint: '上游总扣费',
    resetPending: '待刷新',
  ...
  admin: {
    ...
    subscriptions: {
      ...
      adjustHint: '留空表示不调整天数；输入正数延长订阅，负数缩短订阅（缩短后剩余天数需大于0）',
      ...
      resetQuotaConfirm: "请选择要重置 '{user}' 的配额窗口。勾选窗口的用量将归零并从当前时刻重新计算。",
      ...
      revokeConfirm: "确定要撤销 '{user}' 的订阅吗？撤销后会进入已撤销分类，可稍后恢复。",
      restoreConfirm: "确定要恢复 '{user}' 的已撤销订阅吗？恢复后会按到期时间自动显示为生效中或已过期。",
      hardDeleteConfirm: "确定要永久删除 '{user}' 的订阅记录吗？这是硬删除，删除后不可恢复。",

      guide: {
        title: '订阅管理教程',
        subtitle: '订阅模式允许你按时间周期为用户分配使用额度，支持日/周/月/自定义配额限制。按照以下步骤即可完成配置。',
        showGuide: '使用指南',
        step1: {
          title: '创建订阅分组',
          line1: '前往「分组管理」页面，点击「创建分组」',
          line2: '将计费类型设为「订阅」，配置日/周/月/自定义额度限制',
          line3: '保存分组，确保状态为「正常」',
          link: '前往分组管理'
        },
        step2: {
        ...
        actions: {
          adjust: '调整',
          adjustDesc: '调整订阅有效期或各窗口已用额度',
          resetQuota: '重置配额',
          resetQuotaDesc: '将日/周/月/自定义用量归零，重新开始计算',
          revoke: '撤销',
    ...
    accounts: {
      ...
      dataExportIncludeProxies: '包含关联代理（导出账号所绑定的代理）',
      dataImport: '导入',
      moreActions: '更多操作',
      dataActions: '数据操作',
      toolActions: '工具',
      ...
      // Schedulable toggle
      schedulable: '参与调度',
      schedulableHint: '开启后账号会参与 API 请求调度',
      ...
      tokenRefreshed: '令牌刷新成功',
      accountDeleted: '账号删除成功',
      rateLimitCleared: '限流状态已清除',
      ...
      autoOpsDialog: {
        ...
        stepStatus: {
          action_executed: '\u5df2\u6267\u884c\u5904\u7f6e',
          action_failed: '\u5904\u7f6e\u5931\u8d25',
          loop_guard_stopped: '\u5df2\u88ab\u5faa\u73af\u62a4\u680f\u7ec8\u6b62',
          no_rule_matched: '\u65e0\u89c4\u5219\u547d\u4e2d',
    ...
    ops: {
      ...
      openaiTokenStats: {
        ...
        failedToLoad: '加载 OpenAI 令牌统计失败',
        empty: '当前筛选条件下暂无 OpenAI 令牌请求统计数据',
        table: {
          model: '模型',
          requestCount: '请求数',
          avgTokensPerSec: '平均 Tokens/秒',
          avgFirstTokenMs: '平均首令牌延迟（ms）',
          totalOutputTokens: '输出令牌总数',
          avgDurationMs: '平均时长(ms)',
          requestsWithFirstToken: '首令牌样本数'
        }
      },
      customTimeRange: {
        startTime: '开始时间',
      ...
      settings: {
        ...
        displayOpenAITokenStats: '展示 OpenAI 令牌请求统计',
        displayOpenAITokenStatsHint: '控制运维监控仪表盘中 OpenAI 令牌请求统计卡片是否显示，默认关闭。',
        autoRefreshCountdown: '自动刷新：{seconds}s',
        validation: {
          title: '请先修正以下问题',
      ...
      tooltips: {
        ...
        ttft: '首令牌延迟（Time To First Token），衡量流式响应返回首个令牌的速度。',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksPlaceholder: '留空时使用内置 3 个 blocks。支持数组或 JSON 对象 blocks。',
      ...
      openaiFastPolicy: {
        ...
        description: '配置 OpenAI service_tier 的透传、过滤或拦截策略。默认保留 fast/priority 行为，flex 低价模式会被强制降级为标准模式。',
        flexForcedHint: '系统强制不允许命中 flex 低价模式：用户传入 flex 时会自动移除 service_tier，按标准模式转发与计费。',
        empty: '暂无自定义规则。flex 低价模式仍会被系统强制过滤。',
        ruleHeader: '规则 {index}',
        removeRule: '移除规则',
        serviceTier: '服务挡位',
        tierAll: '全部已识别挡位',
        tierPriority: 'priority / fast',
        tierFlex: 'flex（低价，强制标准）',
        tierAuto: 'auto',
        tierDefault: 'default',
        tierScale: 'scale',
        action: '处理方式',
        actionPass: '透传',
        actionFilter: '过滤为标准模式',
        actionBlock: '拦截请求',
        scope: '生效范围',
        scopeAll: '全部账号',
        scopeOAuth: '仅 OAuth 账号',
        ...
        errorMessagePlaceholder: '拦截时返回的自定义错误消息',
        modelWhitelist: '模型白名单',
        modelWhitelistHint: '留空则对所有模型生效。支持精确匹配和通配符前缀（如 gpt-5*）',
        modelPatternPlaceholder: '例如: gpt-5* 或 gpt-4.1',
        addModelPattern: '添加模型规则',
        fallbackAction: '未匹配模型处理方式',
        addRule: '添加规则',
