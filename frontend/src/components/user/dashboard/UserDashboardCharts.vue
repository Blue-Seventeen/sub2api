            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr v-for="model in models" :key="model.model" class="border-t border-gray-100 dark:border-dark-700">
                  ...
                  <td class="py-1.5 text-right text-green-600 dark:text-green-400">{{ formatCostAmount(model.actual_cost) }}</td>
                  <td class="py-1.5 text-right text-gray-400 dark:text-gray-500">{{ formatCostAmount(model.cost) }}</td>
                </tr>
              </tbody>
            </table>
          </div>
...
import { formatCostAmount, formatNumberLocaleString as formatNumber, formatTokensK as formatTokens } from '@/utils/format'
