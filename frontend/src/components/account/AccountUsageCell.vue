...
import { formatCompactNumber, formatCurrencyAmount, formatRelativeTime } from '@/utils/format'
...
const formatKeyCost = computed(() => {
  if (!props.todayStats) return formatCurrencyAmount(0)
  return formatCurrencyAmount(props.todayStats.cost)
})

const formatKeyUserCost = computed(() => {
  if (!props.todayStats || props.todayStats.user_cost == null) return formatCurrencyAmount(0)
  return formatCurrencyAmount(props.todayStats.user_cost)
})
