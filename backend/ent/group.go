...
type Group struct {
	...
	// 高峰时段叠加倍率，仅在 peak_rate_enabled 且处于 [peak_start, peak_end) 时乘入所有计费模式
	PeakRateMultiplier float64 `json:"peak_rate_multiplier,omitempty"`
	// 高峰时段多窗口配置，旧单段字段保留为第一段兼容快照
	PeakRateWindows []domain.PeakRateWindow `json:"peak_rate_windows,omitempty"`
	...
	// CustomLimitHours holds the value of the "custom_limit_hours" field.
	CustomLimitHours int `json:"custom_limit_hours,omitempty"`
	// CustomLimitUsd holds the value of the "custom_limit_usd" field.
	...
	// Enable New-API style adapter for accounts selected through this group
	NewapiStyleInterfaceEnabled bool `json:"newapi_style_interface_enabled,omitempty"`
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldPeakRateWindows, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldReasoningEffortMappings:
			values[i] = new([]byte)
		case group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldNewapiStyleInterfaceEnabled:
			values[i] = new(sql.NullBool)
		case group.FieldRateMultiplier, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldCustomLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall:
			values[i] = new(sql.NullFloat64)
		case group.FieldID, group.FieldCustomLimitHours, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit:
	...
	for i := range columns {
		...
		case group.FieldPeakRateWindows:
			if value, ok := values[i].(*[]byte); !ok {
				return fmt.Errorf("unexpected type %T for field peak_rate_windows", values[i])
			} else if value != nil && len(*value) > 0 {
				if err := json.Unmarshal(*value, &_m.PeakRateWindows); err != nil {
					return fmt.Errorf("unmarshal field peak_rate_windows: %w", err)
				}
			}
		...
		case group.FieldCustomLimitHours:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field custom_limit_hours", values[i])
			} else if value.Valid {
				_m.CustomLimitHours = int(value.Int64)
			}
		...
		case group.FieldNewapiStyleInterfaceEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field newapi_style_interface_enabled", values[i])
			} else if value.Valid {
				_m.NewapiStyleInterfaceEnabled = value.Bool
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("peak_rate_windows=")
	builder.WriteString(fmt.Sprintf("%v", _m.PeakRateWindows))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("custom_limit_hours=")
	builder.WriteString(fmt.Sprintf("%v", _m.CustomLimitHours))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("newapi_style_interface_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.NewapiStyleInterfaceEnabled))
	builder.WriteString(", ")
