...
const (
	...
	// FieldNewapiStyleInterfaceEnabled holds the string denoting the newapi_style_interface_enabled field in the database.
	FieldNewapiStyleInterfaceEnabled = "newapi_style_interface_enabled"
...
var Columns = []string{
	...
	FieldNewapiStyleInterfaceEnabled,
...
var (
	...
	// DefaultNewapiStyleInterfaceEnabled holds the default value on creation for the "newapi_style_interface_enabled" field.
	DefaultNewapiStyleInterfaceEnabled bool
...
// ByNewapiStyleInterfaceEnabled orders the results by the newapi_style_interface_enabled field.
func ByNewapiStyleInterfaceEnabled(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldNewapiStyleInterfaceEnabled, opts...).ToFunc()
}
