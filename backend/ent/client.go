...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.PromoCodeUsage, c.PromotionActivation, c.PromotionCommissionRecord,
		c.PromotionLevelConfig, c.PromotionScript, c.PromotionSetting,
		c.PromotionSettlementBatch, c.PromotionUser, c.Proxy, c.RedeemCode,
