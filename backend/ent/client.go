...
type (
	hooks struct {
		...
		PromoCodeUsage, PromotionActivation, PromotionCommissionRecord,
		PromotionLevelConfig, PromotionScript, PromotionSetting,
		PromotionSettlementBatch, PromotionUser, Proxy, RedeemCode, SecuritySecret,
