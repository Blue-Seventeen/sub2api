...
func init() {
	...
	// groupDescPeakRateWindows is the schema descriptor for peak_rate_windows field.
	groupDescPeakRateWindows := groupFields[7].Descriptor()
	// group.DefaultPeakRateWindows holds the default value on creation for the peak_rate_windows field.
	group.DefaultPeakRateWindows = groupDescPeakRateWindows.Default.([]domain.PeakRateWindow)
	...
	// groupDescCustomLimitHours is the schema descriptor for custom_limit_hours field.
	groupDescCustomLimitHours := groupFields[16].Descriptor()
	// group.DefaultCustomLimitHours holds the default value on creation for the custom_limit_hours field.
	group.DefaultCustomLimitHours = groupDescCustomLimitHours.Default.(int)
	...
	// groupDescNewapiStyleInterfaceEnabled is the schema descriptor for newapi_style_interface_enabled field.
	groupDescNewapiStyleInterfaceEnabled := groupFields[47].Descriptor()
	// group.DefaultNewapiStyleInterfaceEnabled holds the default value on creation for the newapi_style_interface_enabled field.
	group.DefaultNewapiStyleInterfaceEnabled = groupDescNewapiStyleInterfaceEnabled.Default.(bool)
	...
	// usagelogDescRealActualCost is the schema descriptor for real_actual_cost field.
	usagelogDescRealActualCost := usagelogFields[25].Descriptor()
	// usagelog.DefaultRealActualCost holds the default value on creation for the real_actual_cost field.
	usagelog.DefaultRealActualCost = usagelogDescRealActualCost.Default.(float64)
	// usagelogDescUnifiedRateMultiplier is the schema descriptor for unified_rate_multiplier field.
	usagelogDescUnifiedRateMultiplier := usagelogFields[26].Descriptor()
	// usagelog.DefaultUnifiedRateMultiplier holds the default value on creation for the unified_rate_multiplier field.
	usagelog.DefaultUnifiedRateMultiplier = usagelogDescUnifiedRateMultiplier.Default.(float64)
	...
	usagelogDescRequestType := usagelogFields[31].Descriptor()
	...
	// usagelogDescBillableDurationSeconds is the schema descriptor for billable_duration_seconds field.
	usagelogDescBillableDurationSeconds := usagelogFields[38].Descriptor()
	// usagelog.DefaultBillableDurationSeconds holds the default value on creation for the billable_duration_seconds field.
	usagelog.DefaultBillableDurationSeconds = usagelogDescBillableDurationSeconds.Default.(int)
	// usagelogDescBillableCharacterCount is the schema descriptor for billable_character_count field.
	usagelogDescBillableCharacterCount := usagelogFields[39].Descriptor()
	// usagelog.DefaultBillableCharacterCount holds the default value on creation for the billable_character_count field.
	usagelog.DefaultBillableCharacterCount = usagelogDescBillableCharacterCount.Default.(int)
	...
	// usagelogDescRequestCount is the schema descriptor for request_count field.
	usagelogDescRequestCount := usagelogFields[45].Descriptor()
	// usagelog.DefaultRequestCount holds the default value on creation for the request_count field.
	usagelog.DefaultRequestCount = usagelogDescRequestCount.Default.(int)
	// usagelogDescTaskCount is the schema descriptor for task_count field.
	usagelogDescTaskCount := usagelogFields[46].Descriptor()
	// usagelog.DefaultTaskCount holds the default value on creation for the task_count field.
	usagelog.DefaultTaskCount = usagelogDescTaskCount.Default.(int)
	// usagelogDescUsageEstimated is the schema descriptor for usage_estimated field.
	usagelogDescUsageEstimated := usagelogFields[47].Descriptor()
	...
	// usagelogDescBillableUnitType is the schema descriptor for billable_unit_type field.
	usagelogDescBillableUnitType := usagelogFields[48].Descriptor()
	// usagelog.BillableUnitTypeValidator is a validator for the "billable_unit_type" field. It is called by the builders before save.
	usagelog.BillableUnitTypeValidator = usagelogDescBillableUnitType.Validators[0].(func(string) error)
	...
	usagelogDescServiceTier := usagelogFields[52].Descriptor()
	...
	usagelogDescReasoningEffort := usagelogFields[53].Descriptor()
	...
	usagelogDescInboundEndpoint := usagelogFields[54].Descriptor()
	...
	usagelogDescUpstreamEndpoint := usagelogFields[55].Descriptor()
	...
	// usagelogDescClientProfile is the schema descriptor for client_profile field.
	usagelogDescClientProfile := usagelogFields[56].Descriptor()
	// usagelog.ClientProfileValidator is a validator for the "client_profile" field. It is called by the builders before save.
	usagelog.ClientProfileValidator = usagelogDescClientProfile.Validators[0].(func(string) error)
	// usagelogDescCompatibilityRoute is the schema descriptor for compatibility_route field.
	usagelogDescCompatibilityRoute := usagelogFields[57].Descriptor()
	// usagelog.CompatibilityRouteValidator is a validator for the "compatibility_route" field. It is called by the builders before save.
	usagelog.CompatibilityRouteValidator = usagelogDescCompatibilityRoute.Validators[0].(func(string) error)
	// usagelogDescUpstreamTransport is the schema descriptor for upstream_transport field.
	usagelogDescUpstreamTransport := usagelogFields[59].Descriptor()
	// usagelog.UpstreamTransportValidator is a validator for the "upstream_transport" field. It is called by the builders before save.
	usagelog.UpstreamTransportValidator = usagelogDescUpstreamTransport.Validators[0].(func(string) error)
	// usagelogDescCacheTTLOverridden is the schema descriptor for cache_ttl_overridden field.
	usagelogDescCacheTTLOverridden := usagelogFields[60].Descriptor()
	// usagelog.DefaultCacheTTLOverridden holds the default value on creation for the cache_ttl_overridden field.
	usagelog.DefaultCacheTTLOverridden = usagelogDescCacheTTLOverridden.Default.(bool)
	// usagelogDescCreatedAt is the schema descriptor for created_at field.
	usagelogDescCreatedAt := usagelogFields[61].Descriptor()
	...
	// userDescUnifiedRateEnabled is the schema descriptor for unified_rate_enabled field.
	userDescUnifiedRateEnabled := userFields[4].Descriptor()
	// user.DefaultUnifiedRateEnabled holds the default value on creation for the unified_rate_enabled field.
	user.DefaultUnifiedRateEnabled = userDescUnifiedRateEnabled.Default.(bool)
	// userDescUnifiedRateMultiplier is the schema descriptor for unified_rate_multiplier field.
	userDescUnifiedRateMultiplier := userFields[5].Descriptor()
	// user.DefaultUnifiedRateMultiplier holds the default value on creation for the unified_rate_multiplier field.
	user.DefaultUnifiedRateMultiplier = userDescUnifiedRateMultiplier.Default.(float64)
	// userDescFrozenBalance is the schema descriptor for frozen_balance field.
	userDescFrozenBalance := userFields[6].Descriptor()
	...
	// usersubscriptionDescCustomUsageUsd is the schema descriptor for custom_usage_usd field.
	usersubscriptionDescCustomUsageUsd := usersubscriptionFields[12].Descriptor()
	// usersubscription.DefaultCustomUsageUsd holds the default value on creation for the custom_usage_usd field.
	usersubscription.DefaultCustomUsageUsd = usersubscriptionDescCustomUsageUsd.Default.(float64)
