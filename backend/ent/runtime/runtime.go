...
func init() {
	...
	groupDescNewapiStyleInterfaceEnabled := groupFields[36].Descriptor()
	...
	usagelogDescBillableDurationSeconds := usagelogFields[36].Descriptor()
	...
	usagelogDescBillableCharacterCount := usagelogFields[37].Descriptor()
