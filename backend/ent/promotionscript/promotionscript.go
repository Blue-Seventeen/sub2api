...
const (
	// Label holds the string label denoting the promotionscript type in the database.
	Label = "promotion_script"
	...
	// Table holds the table name of the promotionscript in the database.
	Table = "promotion_scripts"
)

// Columns holds all SQL columns for promotionscript fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldCategory,
...
// OrderOption defines the ordering options for the PromotionScript queries.
