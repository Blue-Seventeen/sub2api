...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	billingCacheService.SetUserGroupRateRepository(userGroupRateRepository)
	...
	opsService.SetCompatibleGatewayService(compatibleGatewayService)
	...
	adminPromotionHandler := admin.NewPromotionHandler(promotionService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, compatibleGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, promotionHandler, idempotencyCoordinator, idempotencyCleanupService)
