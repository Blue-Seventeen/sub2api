-- Allow GitHub/Google email OAuth providers without changing existing auth rows.
...
ALTER TABLE auth_identity_channels ADD CONSTRAINT auth_identity_channels_provider_type_check
    CHECK (provider_type IN ('email', 'linuxdo', 'wechat', 'oidc', 'github', 'google'));
