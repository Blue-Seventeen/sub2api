-- Risk-Control content moderation config and audit logs.
-- Feature is default-off; runtime checks only activate when risk_control_enabled=true.
...
INSERT INTO settings (key, value, updated_at)
VALUES ('content_moderation_config', '', NOW())
ON CONFLICT (key) DO NOTHING;
