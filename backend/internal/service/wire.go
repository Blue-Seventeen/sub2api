...
func ProvidePromotionSettlementRunnerService(promotionService *PromotionService, cfg *config.Config, lockCache LeaderLockCache, db *sql.DB) *PromotionSettlementRunnerService {
...
func ProvideUserPlatformQuotaUsageFlusher(cfg *config.Config, cache BillingCache, quotaRepo UserPlatformQuotaRepository, tw *TimingWheelService, lockCache LeaderLockCache, db *sql.DB) *UserPlatformQuotaUsageFlusher {
...
// ProvideAffiliateService keeps upstream Affiliate wiring available without
...
func ProvidePaymentService(entClient *dbent.Client, registry *payment.Registry, loadBalancer payment.LoadBalancer, redeemService *RedeemService, subscriptionSvc *SubscriptionService, configService *PaymentConfigService, userRepo UserRepository, groupRepo GroupRepository, billingCacheService *BillingCacheService, notificationEmailService *NotificationEmailService, affiliateService *AffiliateService) *PaymentService {
