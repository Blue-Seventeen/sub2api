...
func extractOpenAIUsageFromJSONBytes(body []byte) (OpenAIUsage, bool) {
	...
	return OpenAIUsage{
		...
		CacheCreationInputTokens: firstExistingGJSONInt(values[7], values[8], values[9], values[10], values[11], values[12]),
		ImageOutputTokens:        firstExistingGJSONInt(values[13]),
	}, true
}
