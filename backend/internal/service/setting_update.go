...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	if err := s.saveDisplayCurrencySymbolLocalConfig(settings.DisplayCurrencySymbolLocalOnly, displayCurrencySymbol); err != nil {
		return nil, err
	}
...
func (s *SettingService) refreshCachedSettings(settings *SystemSettings) {
	...
	riskControlSwitchSF.Forget(SettingKeyRiskControlEnabled)
	...
	markdownPagesSwitchSF.Forget(SettingKeyMarkdownPagesEnabled)
