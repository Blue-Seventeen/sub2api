...
func (s *OpenAIGatewayService) RecordUsage(ctx context.Context, input *OpenAIRecordUsageInput) error {
	...
	videoMultiplier := computePeakAwareVideoMultiplier(apiKey, finalBaseMultiplier, pricingAt)
	realVideoMultiplier := computePeakAwareVideoMultiplier(apiKey, baseMultiplier, pricingAt)
