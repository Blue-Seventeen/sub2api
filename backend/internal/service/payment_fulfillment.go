...
func (s *PaymentService) doSub(ctx context.Context, o *dbent.PaymentOrder) error {
	...
	assigned := s.hasAuditLog(ctx, o.ID, "SUBSCRIPTION_ASSIGNED") ||
		s.hasAuditLog(ctx, o.ID, "SUBSCRIPTION_SUCCESS") ||
		s.subscriptionOrderAlreadyApplied(ctx, o.UserID, gid, orderNote)
	if assigned {
