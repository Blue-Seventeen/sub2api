...
func NewAuthService(
	...
	defaultSubAssigner DefaultSubscriptionAssigner,
	userPlatformQuotaRepo UserPlatformQuotaRepository,
	legacyUserPlatformQuotaRepo ...UserPlatformQuotaRepository,
) *AuthService {
	if userPlatformQuotaRepo == nil && len(legacyUserPlatformQuotaRepo) > 0 {
		userPlatformQuotaRepo = legacyUserPlatformQuotaRepo[0]
	}
	return &AuthService{
		entClient:             entClient,
		userRepo:              userRepo,
