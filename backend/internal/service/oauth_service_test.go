...
func (m *mockProxyRepoForOAuth) ExistsByProtocolHostPortAuth(ctx context.Context, protocol, host string, port int, username, password string) (bool, error) {
	panic("ExistsByProtocolHostPortAuth not implemented")
}
