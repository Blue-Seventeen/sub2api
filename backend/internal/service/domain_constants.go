...
const (
	...
	SettingKeyProxyAutoProbeConfig = "proxy_auto_probe_config"
)
...
const (
	...
	AdjustmentTypePromotionBalance = domain.AdjustmentTypePromotionBalance // 推广收益结算/冲回余额流水
)
...
const (
	...
	SettingKeyDisplayCurrencySymbol       = "display_currency_symbol"       // 前端金额展示货币符号
	...
	// SettingKeyRewriteMessageCacheControl controls legacy messages cache_control rewriting.
	SettingKeyRewriteMessageCacheControl = "rewrite_message_cache_control"
	// SettingKeyOpenAICodexUserAgent stores the UA used for OpenAI OAuth browser-UA rewriting.
