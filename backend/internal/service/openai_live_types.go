...
const (
	...
	// OpenAI Live is absorbed from upstream but intentionally disabled in the
	// custom build until it participates in unified billing and quota settlement.
	OpenAILiveFeatureEnabled = false
	OpenAILiveDisabledReason = "OpenAI Live is disabled until unified billing integration is implemented"
)
