...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	...
	// For admin/promotion balance adjustments, include notes so users can see
	// why they were charged or credited.
	if (rc.Type == "admin_balance" || rc.Type == "admin_concurrency" || rc.Type == "promotion_balance") && rc.Notes != "" {
		out.Notes = &rc.Notes
	}
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		BillableCharacterCount:    l.BillableCharacterCount,
...
func userSubscriptionFromServiceBase(sub *service.UserSubscription) UserSubscription {
	return UserSubscription{
		...
		EffectiveAvailableUSD:    sub.EffectiveAvailableUSD,
		EffectiveResetsAt:        sub.EffectiveResetsAt,
		EffectiveDailyResetsAt:   sub.EffectiveDailyResetsAt,
		EffectiveWeeklyResetsAt:  sub.EffectiveWeeklyResetsAt,
		EffectiveMonthlyResetsAt: sub.EffectiveMonthlyResetsAt,
		EffectiveCustomResetsAt:  sub.EffectiveCustomResetsAt,
		EffectiveDailyUsageUSD:   sub.EffectiveDailyUsageUSD,
		EffectiveWeeklyUsageUSD:  sub.EffectiveWeeklyUsageUSD,
		EffectiveMonthlyUsageUSD: sub.EffectiveMonthlyUsageUSD,
		EffectiveCustomUsageUSD:  sub.EffectiveCustomUsageUSD,
		DailyWindowStart:         sub.DailyWindowStart,
		WeeklyWindowStart:        sub.WeeklyWindowStart,
		MonthlyWindowStart:       sub.MonthlyWindowStart,
		CustomWindowStart:        sub.CustomWindowStart,
