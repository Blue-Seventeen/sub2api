...
func NewOpenAIOAuthHandler(
	...
	rateLimitServices ...*service.RateLimitService,
) *OpenAIOAuthHandler {
	...
	if len(rateLimitServices) > 0 {
		rateLimitService = rateLimitServices[0]
	}
...
func (h *OpenAIOAuthHandler) RefreshToken(c *gin.Context) {
	...
	if req.ProxyID != nil {
		...
		if err == nil && proxy != nil {
			proxyURL = service.ResolveProxyURL(c.Request.Context(), proxy)
		}
	}
