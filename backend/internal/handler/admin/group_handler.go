...
type CreateGroupRequest struct {
	...
	Platform         string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok zhipu deepseek volcengine ali moonshot perplexity mistral siliconflow openrouter suno kling midjourney"`
