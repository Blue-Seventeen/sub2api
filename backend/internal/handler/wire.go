...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, newAPIStyleService, openAIGatewayService, geminiCompatService, antigravityGatewayService,
		userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, proxyStatsWorkerPool, proxyActiveUsageTracker,
...
func ProvideHandlers(
	...
	newAPIStyleGatewayHandler *NewAPIStyleGatewayHandler,
	...
	return &Handlers{
		...
		NewAPIStyleGateway: newAPIStyleGatewayHandler,
