...
func SetupRouter(
	...
	setupEmbeddedFrontend(r, settingService, refreshFrameOrigins)
...
func registerRoutes(
	...
	// 注册各模块路由
	routes.RegisterAuthRoutes(v1, h, jwtAuth, auditLog, redisClient, settingService, cfg, panelRateLimiter)
