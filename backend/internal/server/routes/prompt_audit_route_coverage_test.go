...
func TestEveryGatewayPOSTRouteIsClassifiedForPromptAuditCoverage(t *testing.T) {
	...
	audited := map[string][]string{
		...
		"/audio/*subpath":             {"newapi_style_gateway_handler.go"},
		"/api/paas/v4/audio/*subpath": {"newapi_style_gateway_handler.go"},
		"/api/v1/services/aigc/multimodal-generation/generation": {"newapi_style_gateway_handler.go"},
		"/rerank":                              {"newapi_style_gateway_handler.go"},
		"/videos":                              {"newapi_style_gateway_handler.go"},
		"/videos/:id":                          {"newapi_style_gateway_handler.go"},
		"/video/generations":                   {"newapi_style_gateway_handler.go"},
		"/video/generations/*subpath":          {"newapi_style_gateway_handler.go"},
		"/compatible-mode/v1/chat/completions": {"compatible_gateway_handler.go"},
	}
